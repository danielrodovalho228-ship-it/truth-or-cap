// Client-safe slice of the question pool.
// The full pool (104 prompts) lives in `lib/questions-server.ts` to keep
// it out of the client bundle. PlayCTA's reroll only needs a small slice.
//
// TODO: when we move reroll to the server, drop this file entirely and
// import from `lib/questions-server.ts` everywhere.
