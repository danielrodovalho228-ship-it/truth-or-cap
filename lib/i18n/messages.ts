...
const en: Dict = {
  ...
  'settings.streak.daysSuffix': 'days',
  'settings.lang.title': 'Language',
  'settings.lang.subtitle': 'Pick your interface language',
  'settings.privacy.title': 'Privacy',
  'settings.privacy.subtitle': 'Public profile, contacts, data',
  'settings.notifications.title': 'Notifications',
  'settings.notifications.subtitle': 'Push prefs (coming soon)',
  'settings.delete.title': 'Delete account',
  'settings.delete.subtitle': 'Cascade delete + LGPD/GDPR',
  'settings.signout.title': 'Sign out',
  'settings.signout.subtitle': 'Clear session',
...
const pt: Dict = {
  ...
  'settings.back': '← Início',
  'settings.label': 'Ajustes',
  'settings.title.line1': 'Seus',
  'settings.title.line2': 'controles.',
  'settings.premium': 'Premium',
  'settings.row.username': 'Username',
  'settings.row.email': 'Email',
  'settings.row.streak': 'Streak',
  'settings.streak.daysSuffix': 'dias',
  'settings.lang.title': 'Idioma',
  'settings.lang.subtitle': 'Escolhe o idioma da interface',
  'settings.privacy.title': 'Privacidade',
  'settings.privacy.subtitle': 'Perfil público, contatos, dados',
  'settings.notifications.title': 'Notificações',
  'settings.notifications.subtitle': 'Push (em breve)',
  'settings.delete.title': 'Excluir conta',
  'settings.delete.subtitle': 'Exclusão em cascata + LGPD/GDPR',
  'settings.signout.title': 'Sair',
  'settings.signout.subtitle': 'Encerrar sessão',
  'settings.legal': 'Legal',
